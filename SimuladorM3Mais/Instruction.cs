...
namespace M3PlusMicrocontroller {
    ...
    public class Instruction {
        ...
        public static Instruction OR_D_A() {
            Instruction instruction = new Instruction("OR E, A", "Faz a operação OR do registrador D com o acumulador e o resultado se mantém no acumulador.", 1);
            instruction.Function = delegate (Simulator simulator) {
                simulator.Reg[0] = (byte)(simulator.Reg[3] | simulator.Reg[0]);
                simulator.Flag_Z = simulator.Reg[0] == 0;
                simulator.Flag_C = false;
        ...
        public static Instruction XOR_D_A() {
            Instruction instruction = new Instruction("XOR E, A", "Faz a operação XOR do registrador D com o acumulador e o resultado se mantém no acumulador.", 1);
            instruction.Function = delegate (Simulator simulator) {
                simulator.Reg[0] = (byte)(simulator.Reg[3] ^ simulator.Reg[0]);
                simulator.Flag_Z = simulator.Reg[0] == 0;
                simulator.Flag_C = false;
