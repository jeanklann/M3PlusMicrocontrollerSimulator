...
namespace IDE
{
    public partial class FormRamMemory : Form
    {
        ...
        private static readonly byte[] _ramTemp = new byte[256];
        private static readonly byte[] _stackTemp = new byte[256];
        ...
        public void Build(FormRamType type)
        {
            ...
            for (var i = 1; i < total; i++) tableLayoutPanel1.RowStyles.RemoveAt(i);
            ...
            for (var i = 0; i < 256; i++)
            {
                ...
                field.Selected = DataFieldType.Hex;
        ...
        private void Run_thread()
        {
            ...
            foreach (var item in Fields) item.Dispose();
            Fields.Clear();
        }
