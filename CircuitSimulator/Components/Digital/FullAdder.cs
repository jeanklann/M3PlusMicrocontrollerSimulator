namespace CircuitSimulator
{
    ...
    public class FullAdder : Chip
    {
        ...
        {
            for (var i = 0; i < 3; i++) Pins[i] = new Pin(this, false, false);
            for (var i = 3; i < 5; i++) Pins[i] = new Pin(this, true, false);
        }
        ...
        protected internal override void Execute()
        {
            ...
            for (var i = 0; i < 3; i++) Pins[i].Propagate();
        }
    }
}